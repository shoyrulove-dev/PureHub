...
- Release: <https://github.com/shoyrulove-dev/PureHub/releases/tag/v1.0.0-beta.21>
- F-Droid universal APK: <https://github.com/shoyrulove-dev/PureHub/releases/download/v1.0.0-beta.21/PureHub-1.0.0-beta.21-fdroid.apk>
- F-Droid arm64 APK: <https://github.com/shoyrulove-dev/PureHub/releases/download/v1.0.0-beta.21/PureHub-1.0.0-beta.21-fdroid-arm64-v8a.apk>
...
Latest release: https://github.com/shoyrulove-dev/PureHub/releases/tag/v1.0.0-beta.21
APK: https://github.com/shoyrulove-dev/PureHub/releases/download/v1.0.0-beta.21/PureHub-1.0.0-beta.21-fdroid.apk

PureHub is a free, ad-free, offline-first collection of 26 Android utilities for scanning, OCR/PDF workflows, focus, measurement, finance, audio care, files, creation, and privacy.
...
Verify the universal APK against `SHA256SUMS.txt` attached to the release.
