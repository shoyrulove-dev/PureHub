...
- Release: <https://github.com/shoyrulove-dev/PureHub/releases/tag/v1.0.0-beta.40>
- F-Droid universal APK: <https://github.com/shoyrulove-dev/PureHub/releases/download/v1.0.0-beta.40/PureHub-1.0.0-beta.40-fdroid.apk>
