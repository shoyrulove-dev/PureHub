...
- Release: <https://github.com/shoyrulove-dev/PureHub/releases/tag/v1.0.0-beta.37>
- F-Droid universal APK: <https://github.com/shoyrulove-dev/PureHub/releases/download/v1.0.0-beta.37/PureHub-1.0.0-beta.37-fdroid.apk>
