...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 36
        versionCode = providers.environmentVariable("PUREHUB_VERSION_CODE").orNull?.toIntOrNull() ?: 33
        versionName = providers.environmentVariable("PUREHUB_VERSION_NAME").orNull ?: "1.0.0-beta.32"
