# PureHub social profile kit

## Identity

- Display name: `PureHub`
- Preferred handle: `@PureHub`
- Handle fallback: `@PureHubTools`
...
- Name: `PureHub`
- Handle: try `@PureHub`, then `@PureHubTools`
- Description:
...
Expect short tool demos, transparent engineering updates, Android beta tests, and community roadmap votes.

Explore PureHub and help choose what we improve next.
```
...
Enable profile discoverability and public search indexing.
